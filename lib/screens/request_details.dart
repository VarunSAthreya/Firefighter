                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      Text(
                        'Asset location: ${machine.value!.address}',
                        softWrap: true,
                        textAlign: TextAlign.center,
                        textScaleFactor: 1.2,
                      ),
                      const SizedBox(height: 20),
                      Text(
                        'Asset Total services: ${machine.value!.services.length}',
                        softWrap: true,
                        textAlign: TextAlign.center,
                        textScaleFactor: 1.1,
                      ),
                      if (machine.value!.lastServiced != null) ...[
                        const SizedBox(height: 20),
                        Text(
                          'Asset previous service: ${dateFormat.format(machine.value!.lastServiced!)}',
                          softWrap: true,
                          textAlign: TextAlign.center,
                          textScaleFactor: 1.2,
                        ),
